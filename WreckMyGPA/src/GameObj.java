...
public class GameObj {
   ...
   if (theta <= diagTheta ) {
    ...
    /** Sets the code for the object, and this code will be typed to
     * collect the object from the game and delete it from the state.
     */
    public void setCode(String newCode) {
        code = newCode;
    }
    
    /** Draws the code string onto the object. 
     * Implementation was aided with StackOverflow.
     */  
    public void drawCode(Graphics g, String text, Font font) {
        // Get the FontMetrics
    ...
    public void drawName(Graphics g, String text, Font font) {
        ...
        int x = ((width - metrics.stringWidth(text)) / 2) + pos_x;
        // Determine the Y coordinate for the text.
        int y = pos_y + metrics.getAscent() + 10;
        // Set the font
        g.setFont(font);
        // Set the color
        g.setColor(Color.BLACK);
